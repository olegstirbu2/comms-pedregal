...
// Arrow Left icon for image viewer navigation - arrow-left.svg
export function ArrowLeftIcon({ size = 16, className = "" }) {
  return (
    <svg width={size} height={size} viewBox="0 0 16 16" fill="none" className={className}>
      <path d="M6.29525 2.29285C6.68578 1.90241 7.31881 1.90235 7.70931 2.29285C8.09971 2.68335 8.09971 3.31641 7.70931 3.70691L4.41634 6.99988H14.0023C14.5545 6.99998 15.0023 7.44765 15.0023 7.99988C15.0023 8.5521 14.5545 8.99978 14.0023 8.99988H4.41634L7.70931 12.2928C8.09971 12.6834 8.09971 13.3164 7.70931 13.7069C7.31881 14.0974 6.68578 14.0973 6.29525 13.7069L1.76888 9.18054C1.11676 8.52838 1.11675 7.47138 1.76888 6.81922L6.29525 2.29285Z" fill="currentColor"/>
    </svg>
  );
}

// Drag Handle icon (6-dot vertical rearrange) - rearrange-vertical.svg
export function DragHandleIcon({ size = 16, className = "" }) {
  return (
    <svg width={size} height={size} viewBox="0 0 16 16" fill="none" className={className}>
      <path d="M7.25 3.5C7.25 4.32843 6.57843 5 5.75 5C4.92157 5 4.25 4.32843 4.25 3.5C4.25 2.67157 4.92157 2 5.75 2C6.57843 2 7.25 2.67157 7.25 3.5Z" fill="currentColor"/>
      <path d="M7.25 8C7.25 8.82843 6.57843 9.5 5.75 9.5C4.92157 9.5 4.25 8.82843 4.25 8C4.25 7.17157 4.92157 6.5 5.75 6.5C6.57843 6.5 7.25 7.17157 7.25 8Z" fill="currentColor"/>
      <path d="M7.25 12.5C7.25 13.3284 6.57843 14 5.75 14C4.92157 14 4.25 13.3284 4.25 12.5C4.25 11.6716 4.92157 11 5.75 11C6.57843 11 7.25 11.6716 7.25 12.5Z" fill="currentColor"/>
      <path d="M11.75 3.5C11.75 4.32843 11.0784 5 10.25 5C9.42157 5 8.75 4.32843 8.75 3.5C8.75 2.67157 9.42157 2 10.25 2C11.0784 2 11.75 2.67157 11.75 3.5Z" fill="currentColor"/>
      <path d="M11.75 8C11.75 8.82843 11.0784 9.5 10.25 9.5C9.42157 9.5 8.75 8.82843 8.75 8C8.75 7.17157 9.42157 6.5 10.25 6.5C11.0784 6.5 11.75 7.17157 11.75 8Z" fill="currentColor"/>
      <path d="M11.75 12.5C11.75 13.3284 11.0784 14 10.25 14C9.42157 14 8.75 13.3284 8.75 12.5C8.75 11.6716 9.42157 11 10.25 11C11.0784 11 11.75 11.6716 11.75 12.5Z" fill="currentColor"/>
    </svg>
  );
}
