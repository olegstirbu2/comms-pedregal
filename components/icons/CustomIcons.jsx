...
export function ChatDefaultLineIcon({ size = 16, className = "" }) {
  return (
    <svg width={size} height={size} viewBox="0 0 16 16" fill="none" className={className}>
      <path
        d="M14 2H2C1.44772 2 1 2.44772 1 3V11C1 11.5523 1.44772 12 2 12H4V14.5858L7.29289 11.2929C7.48043 11.1054 7.73478 11 8 11H14C14.5523 11 15 10.5523 15 10V3C15 2.44772 14.5523 2 14 2Z"
        stroke="currentColor"
        strokeWidth="1.5"
        strokeLinecap="round"
...
export function PromoLineIcon({ size = 16, className = "" }) {
  return (
    <svg width={size} height={size} viewBox="0 0 16 16" fill="none" className={className}>
      <path
        d="M13.5 5.5L10.5 2.5L2 11L2 14L5 14L13.5 5.5Z"
        stroke="currentColor"
        strokeWidth="1.5"
        strokeLinecap="round"
        strokeLinejoin="round"
...
export function SendFillIcon({ size = 24, className = "" }) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" className={className}>
      <path
        d="M3.5 20.5L20.5 12L3.5 3.5L3.5 9.5L13.5 12L3.5 14.5L3.5 20.5Z"
        fill="currentColor"
      />
    </svg>
  );
...
export function SmileyHappyLineIcon({ size = 16, className = "" }) {
  return (
    <svg width={size} height={size} viewBox="0 0 16 16" fill="none" className={className}>
      ...
      <path
        d="M5.5 9.5C5.5 9.5 6.5 11 8 11C9.5 11 10.5 9.5 10.5 9.5"
        stroke="currentColor"
        strokeWidth="1.5"
        strokeLinecap="round"
        fill="none"
